...
//		        }
		...
		String dbUrl= "jdbc:mysql://localhost:3306/rrllabproject"; //Connection String

        String username="root";
        String password = "Kiran522@";
        ...
        while (rs.next()) {
           ...
           SearchStore.searchProduct(productName);
			SearchStore.searchBtn();
	String actual = driver.findElement(By.xpath("/html/body/div[4]/div[1]/div[4]/div[2]/div/div[2]/div[3]/div[1]/div/div/div[2]/h2/a")).getText();
			String expect = "Health Book";
		...
		String s = "Fail";
		        if (!result.equals(s)) {
		        	System.out.println("the first product is not the right product");
		           driver.findElement(By.id("small-searchterms")).clear();
		           driver.navigate().back();
        }
